...
public class DeleteUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        UserTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name ", "Email", "Contact", "Address", "State", "Country", "Registration Id", "Image Name"
            }
        ));
    ...
    private void UserTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UserTableMouseClicked
        try {
            int dialogResult = JOptionPane.showConfirmDialog(null, "*User details\n* Images\n*  Qr Codes\n* Attendence\n\n "
                    + "Associated with user will be deleted.\nAre you sure you want to proceed?", "Conformation", JOptionPane.YES_NO_OPTION);
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                String attendanceDeleteQuery = "DELETE userattendence, userdetails \n" +
"FROM userdetails \n" +
...
"WHERE userdetails.email = ?";
                ...
                fetchUser(null);
                JOptionPane.showMessageDialog(null, "Deletition Sucessfully", "Confirmation",JOptionPane.INFORMATION_MESSAGE);
                
            } else {
                JOptionPane.showMessageDialog(null, "Deletition Canceled", "Confirmation",JOptionPane.INFORMATION_MESSAGE);
            }
